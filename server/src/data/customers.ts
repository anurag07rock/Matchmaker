const handCuratedCustomers: any[] = [
  {
    id: 'cust_01',
    firstName: 'Alexander',
    lastName: 'Wright',
...
function generateExtraCustomers(count: number): any[] {
  const list: any[] = [];
...
export const mockCustomers: any[] = [...handCuratedCustomers, ...generateExtraCustomers(105)];
