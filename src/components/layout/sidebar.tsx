    ...
    <>
      ...
      {isOpen && (
        <div
          ...
          className="fixed inset-0 z-40 bg-[var(--background)]/80 backdrop-blur-sm lg:hidden transition-opacity duration-300"
        />
      )}
      ...
      <aside
        className={cn(
          "fixed top-0 bottom-0 left-0 z-40 w-64 border-r border-[var(--border)] bg-[var(--card)] flex flex-col justify-between transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static",
      ...
      >
        <div>
          ...
          <div className="h-16 flex items-center px-6 border-b border-[var(--border)]">
            ...
            >
              ...
              <span className="font-bold tracking-tight text-[var(--foreground)] group-hover:text-rose-400 transition-colors">
                The Date Crew
              </span>
            </Link>
          </div>
        ...
        <div className="p-4 border-t border-[var(--border)]">
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-[var(--muted-foreground)] hover:bg-red-500/10 hover:text-red-500 border border-transparent hover:border-red-500/20 transition-all duration-200 group"
          >
            <LogOut className="w-4.5 h-4.5 text-[var(--muted-foreground)] group-hover:text-red-500 transition-colors" />
            Sign Out
          </button>
        </div>
      </aside>
